(function() {
    function init() {
        jQuery(function($) {
            function start() {
                var html = str_replace('{countdownId}', countdownId, '                                            \n                    <span id=\"ucd-countdown-{countdownId}-container\"\n                class=\"ucd-countdown-container\"\n            >\n                <span id=\"ucd-countdown-{countdownId}\"\n      class=\"ucd-countdown\n            ucd-countdown-size-large                        is-transparent            \"\n      data-orig-size=\"large\"\n      data-countdown-id=\"{countdownId}\"\n      data-post-id=\"0\"\n      >\n    <span class=\"ucd-countdown-dashes\"><!-- no space\n                    --><span class=\"ucd-countdown-dash ucd-countdown-dash-days ucd-countdown-dash-hidden\">\n                <span class=\"ucd-countdown-dash_title\">Days</span>\n                <span class=\"ucd-countdown-digit\">&nbsp;</span>\n                <span class=\"ucd-countdown-digit\">&nbsp;</span>\n            </span><!-- no space\n                    --><span class=\"ucd-countdown-dash ucd-countdown-dash-hours\">\n                <span class=\"ucd-countdown-dash_title\">Hours</span>\n                <span class=\"ucd-countdown-digit\">&nbsp;</span>\n                <span class=\"ucd-countdown-digit\">&nbsp;</span>\n            </span><!-- no space\n                    --><span class=\"ucd-countdown-dash ucd-countdown-dash-minutes\">\n                <span class=\"ucd-countdown-dash_title\">Minutes</span>\n                <span class=\"ucd-countdown-digit\">&nbsp;</span>\n                <span class=\"ucd-countdown-digit\">&nbsp;</span>\n            </span><!-- no space\n                    --><span class=\"ucd-countdown-dash ucd-countdown-dash-seconds\">\n                <span class=\"ucd-countdown-dash_title\">Seconds</span>\n                <span class=\"ucd-countdown-digit\">&nbsp;</span>\n                <span class=\"ucd-countdown-digit\">&nbsp;</span>\n            </span><!-- no space\n            --></span>\n            <span class=\"ucd-progress\"\n                    >\n            <span class=\"ucd-progress-bar\" role=\"progressbar\"></span>\n        </span>\n    </span>            </span>\n        \n                    <div id=\"ucd-countdown-{countdownId}-content\"\n                 class=\"ucd-countdown-action-content ucd-countdown-content-hidden\"\n                 data-countdown-id=\"{countdownId}\"\n                 data-post-id=\"0\"\n                >\n                    <p style=\"font-size: large;\">This offer has now expired.</p>            </div>\n        \n                                                \n');
                $('#ucd-placeholder-' + countdownId).html(html);

                function stopCounter() {
            $('.ucd-countdown-action-content[data-post-id="0"]').slideDown();
            
    $('.ucd-countdown-extra-content[data-post-id="0"]').slideUp(function() {
        $(this).remove();
    });
}
    ...
    var options = {"omitWeeks":"1","progress_base":"75"};
            var now = new Date();
        options.targetDate = new Date(now.getTime() + 3900000);
    ...
    $('#ucd-countdown-' + countdownId).ucd_countDown(options);
            ...
            if ('undefined' == typeof window.ucd_jsLoaded) {
                loadJs('http://helpful-web.com/remedy/wp-content/plugins/countdown_dynamite/js/jquery/countdown.js');
                loadJs('http://helpful-web.com/remedy/wp-content/plugins/countdown_dynamite/js/frontend.js');
    ...
    if ('undefined' == typeof window.ucd_cssLoaded) {
        loadCss('http://helpful-web.com/remedy/wp-content/plugins/countdown_dynamite/css/countdown.css?ver=03.01.08');

        window.ucd_cssLoaded = true;
    }

    var html = str_replace('{countdownId}', countdownId, '<span id=\"ucd-placeholder-{countdownId}\">    <img alt=\"Loading...\"        src=\"http://helpful-web.com/remedy/wp-content/plugins/countdown_dynamite//images/ajax-placeholder/large.gif\"    ></span>');
    document.write(html);
