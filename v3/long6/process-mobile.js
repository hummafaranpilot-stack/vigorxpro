...
const replacements = [
    ...
    // ClickBank to ClickBank
    ['ClickBank', 'ClickBank'],
    ['CLICKBANK', 'ClickBank'],
    ['clickbank', 'ClickBank'],
    ['Click Sales, Inc., a Delaware corporation located at 1444 S. Entertainment Ave., Suite 410 Boise, ID 83709, USA', 'ClickBank GmbH, located in Germany'],
    ...
    ["<script src='//cbtb.clickbank.net/?vendor=mhmiracle'></script>", '<!-- ClickBank tracking will be added here -->'],
